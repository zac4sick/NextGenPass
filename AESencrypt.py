...
from PasswordGen import * #importing password genaratoe library
clear()
Master_password=str()
primary_color='red'

class AESCipher(object): #AES class (encryption & decryption func)
...
class KeyProcess: #implementing user defined key 
	def __init__(self):
